            ...
            <div className="">
                ...
                <div className="py-10 px-4 sm:py-16 xl:mx-auto xl:max-w-7xl xl:px-8">
                    <div className="px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 xl:px-0">
                        <h2 className="text-2xl font-bold tracking-tight capitalize">salons</h2>
                    </div>
                            ...
                            return (
                                <div class="group relative">
                                    <div class="aspect-h-1 aspect-w-1 h-80 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-80">
                                        <img className='' src={salons.image} alt="" />
                                    </div>
                                    <div class="mt-4 flex justify-between">
                                        <div>
                                            <h2 className='font-bold text-lg'>{salons.name}</h2>
                                            <p class="mt-1 text-md"><MdLocationPin className='inline text-xl text-red-700' />{salons.address}</p>
