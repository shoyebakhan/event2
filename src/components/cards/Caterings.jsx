                                    ...
                                    <div class="mt-4 flex justify-between">
                                        <div>
                                            ...
                                            <dd className='mt-1 px-1'>
                                                <a className="hover:text-green-700 text-green-900 text-md capitalize" href={`tel:+91${caterings.phone}`}>
